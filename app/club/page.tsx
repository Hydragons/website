...
export default function Home() {
    ...
    return (
        <div>
            ...
            <div className='w-full pt-10 lg:px-32 md:px-24 sm:px-10 pb-16'>
                <h2 className='text-udemBlue font-semibold text-3xl mb-2 uppercase pb-5 text-left sm:text-center '>à propos du club</h2>
            ...
            <h2 className='text-udemBlue font-semibold text-3xl mb-2 uppercase text-center pb-5'>où sommes-nous?</h2>

            <div className='grid lg:grid-cols-2 lg:pb-16 sm:grid-cols-none md:grid-cols-2 md:pb-10 sm:pd-5'>

                <div className='text-left lg:mx-auto md:mx-0 sm:mx-0 md:ml-10 sm:ml-10 sm:pb-10'>
                ...
                <div className='max-h-[500px] lg:mx-0 md:mx-0 sm:mx-auto'>
                    <Map />
                </div>
            </div>
            ...
            <div className='w-full lg:px-32 md:px-24 sm:px-10 pb-16'>
                <h2 className='text-udemBlue font-semibold text-3xl mb-2 uppercase pb-5 text-center'>les pratiques</h2>
